...
<html lang="en" style="height: 100%">
    <head>
        <meta charset="utf-8">
        <title>text_matching.py : /home/WineMaster/mysite/text_matching.py : Editor : WineMaster : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="text_matching.py : /home/WineMaster/mysite/text_matching.py : Editor : WineMaster : PythonAnywhere">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          save: "/user/WineMaster/files/home/WineMaster/mysite/text_matching.py",
          check_hash: "/user/WineMaster/files/home/WineMaster/mysite/text_matching.py",
          run: "/user/WineMaster/files/home/WineMaster/mysite/text_matching.py" + "?run",
          update_editor_mode_preference: "/user/WineMaster/account/update_editor_mode_preference",
        });
        var filename = "/home/WineMaster/mysite/text_matching.py";
        var hash = "914b4e578ac2d05d450a48c8fba4934c";
        ...
        Anywhere2.initializeFileSharingOptions(
          $('#id_file_sharing_options')[0],
          {
            ...
            path: "/home/WineMaster/mysite/text_matching.py"
          }
        );
...
<li class=""><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <div>
    <div id="id_ide_split_panes">
        ...
        <div id="id_editor">import numpy as np
import pandas as pd
