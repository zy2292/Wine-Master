...
<html lang="en" style="height: 100%">
    <head>
        <meta charset="utf-8">
        <title>image_ocr.py : /home/WineMaster/mysite/image_ocr.py : Editor : WineMaster : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="image_ocr.py : /home/WineMaster/mysite/image_ocr.py : Editor : WineMaster : PythonAnywhere">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          save: "/user/WineMaster/files/home/WineMaster/mysite/image_ocr.py",
          check_hash: "/user/WineMaster/files/home/WineMaster/mysite/image_ocr.py",
          run: "/user/WineMaster/files/home/WineMaster/mysite/image_ocr.py" + "?run",
          update_editor_mode_preference: "/user/WineMaster/account/update_editor_mode_preference",
        });
        var filename = "/home/WineMaster/mysite/image_ocr.py";
        var hash = "568c51746517b654aaf1da4793e4d002";
        ...
        Anywhere2.initializeFileSharingOptions(
          $('#id_file_sharing_options')[0],
          {
            ...
            path: "/home/WineMaster/mysite/image_ocr.py"
          }
        );
