...
<html lang="en" style="height: 100%">
    <head>
        <meta charset="utf-8">
        <title>sql.py : /home/WineMaster/mysite/sql.py : Editor : WineMaster : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="sql.py : /home/WineMaster/mysite/sql.py : Editor : WineMaster : PythonAnywhere">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          save: "/user/WineMaster/files/home/WineMaster/mysite/sql.py",
          check_hash: "/user/WineMaster/files/home/WineMaster/mysite/sql.py",
          run: "/user/WineMaster/files/home/WineMaster/mysite/sql.py" + "?run",
          update_editor_mode_preference: "/user/WineMaster/account/update_editor_mode_preference",
        });
        var filename = "/home/WineMaster/mysite/sql.py";
        var hash = "44831c3e7b99f1455428fbf0d2cf268e";
        ...
        Anywhere2.initializeFileSharingOptions(
          $('#id_file_sharing_options')[0],
          {
            ...
            path: "/home/WineMaster/mysite/sql.py"
          }
        );
...
<li class=""><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <div>
    <div id="id_ide_split_panes">
        ...
        <div id="id_editor">from flask_app import db
