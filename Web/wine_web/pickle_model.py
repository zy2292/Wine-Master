...
<html lang="en" style="height: 100%">
    <head>
        <meta charset="utf-8">
        <title>pickle_model.py : /home/WineMaster/mysite/pickle_model.py : Editor : WineMaster : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="pickle_model.py : /home/WineMaster/mysite/pickle_model.py : Editor : WineMaster : PythonAnywhere">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          save: "/user/WineMaster/files/home/WineMaster/mysite/pickle_model.py",
          check_hash: "/user/WineMaster/files/home/WineMaster/mysite/pickle_model.py",
          run: "/user/WineMaster/files/home/WineMaster/mysite/pickle_model.py" + "?run",
          update_editor_mode_preference: "/user/WineMaster/account/update_editor_mode_preference",
        });
        var filename = "/home/WineMaster/mysite/pickle_model.py";
        var hash = "036c3879feafe4aac055e7e029fab21e";
        ...
        Anywhere2.initializeFileSharingOptions(
          $('#id_file_sharing_options')[0],
          {
            ...
            path: "/home/WineMaster/mysite/pickle_model.py"
          }
        );
